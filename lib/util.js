...
/**
 * Returns sling content directory name for file
 *
 * @param {String} filePath Example: '/content/foo/bar.txt'
 * @returns {String} '/content/foo'
 */
module.exports.dirName = function (filePath) {
  return path.dirname(filePath)
}

/**
 * Returns sling file name for a file
 *
 * @param {String} filePath Example: '/content/foo/bar.txt'
 * @returns {String} 'bar.txt'
 */
module.exports.fileName = function (filePath) {
